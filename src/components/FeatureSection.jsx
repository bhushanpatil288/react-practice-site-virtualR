...
const FeatureSection = () => {
  return (
    <div className='container mx-auto relative mt-25 pb-25 lg:mt-50 lg:pb-50 border-b border-neutral-700 min-h-[800px]'>
      {/* features heading */}
      ...
      {/* feature cards */}
      <div className='flex flex-wrap mt-10 lg:mt-30'>
